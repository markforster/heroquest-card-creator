...
export default function ExportOptionsForm({
  ...
  const exportSettingsSection = useSettingsGroup ? (
    <SettingsGroup
  ...
  const exportMarksSection = useSettingsGroup ? (
  ...
  if (sectionLayout === "columns") {
    return (
      <div className={styles.exportOptionsFormSectionsColumns}>
