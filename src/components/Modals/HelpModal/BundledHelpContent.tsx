  ...
  return (
    <div className={styles.bundledHelpPage}>
      <header className={styles.bundledHelpHero}>
        ...
        <h2 className={styles.bundledHelpTitle}>Quick Help</h2>
        <p className={styles.bundledHelpIntro}>
          Essential guidance for creating, organising, exporting, and protecting your card library.
        </p>
      </header>

      <div className={styles.bundledHelpLayout}>
        <nav className={styles.bundledHelpContents} aria-label="Quick help contents">
          <h2>On this page</h2>
          <ol>
        ...
        <article className={`${styles.bundledHelpArticle} ${docStyles.docBody}`}>
          <header className={styles.bundledHelpArticleHeader}>
            <h2>Using the card creator</h2>
            <p>
              This quick guide is included with the app, so it remains available when the complete
              online help centre cannot be reached.
            </p>
          </header>
          ...
          <DocSection id="getting-around" title="Getting around">
            <DocParagraph>
              ...
              and the inspector. The LeftNav contains quick actions (Cards, Decks, Assets,
              Settings/Help), the preview shows your card as you edit it, and the inspector on the
              right is where you change titles, rules text, stats, images, and template-specific
              options. Most changes update the preview instantly, so you can trust what you see.
            </DocParagraph>
            <DocParagraph>
            ...
            <DocParagraph>
              You can switch appearance mode (Light, Dark, or System) from Settings or the LeftNav
              theme control.
            </DocParagraph>
          </DocSection>
          ...
          <DocSection id="creating-and-editing" title="Creating and editing cards">
            <DocList>
              ...
              <li>
                Title toolbar controls are template-dependent. Labelled backs can switch
                ribbon/plain styles and top/bottom placement.
              </li>
            </DocList>
          </DocSection>
          ...
          <DocSection id="text-formatting" title="Text, formatting, leader lines, and alignment">
            <DocList>
              ...
              <li>
                ...
                <code> [cost [...] 1gp]</code> and the dots will be drawn between the label and
                value.
              </li>
              <li>
              ...
              <li>
                Inline dice tokens are supported in body text (combat faces, D6 pips, and
                CD/AD/DD/MD), including color and face overrides.
              </li>
              <li>
              ...
              <li>
                On hero and monster cards, the body text grows upward from the bottom while the
                stats strip moves up to make space, mirroring how printed cards behave.
              </li>
            </DocList>
          </DocSection>
          ...
          <DocSection id="images" title="Working with images">
            <DocList>
              ...
              <li>
                Zoom multipliers are literal (1x, 2x, 3x), and full-card coverage remains reachable
                when needed.
              </li>
              ...
              <li>
                In Assets, the Resources menu (book icon) provides quick links to artwork downloads
                and external helper tools, including custom GPT art/icon generators.
              </li>
              <li>
          ...
          <DocSection id="saved-cards" title="Saved cards and the stockpile">
            <DocList>
              ...
              <li>
                When starting from an empty library, Stockpile onboarding can guide setup and
                provide direct Import library actions.
              </li>
            </DocList>
          </DocSection>
          ...
          <DocSection id="decks" title="Decks (organising playable card systems)">
            <DocParagraph>
              ...
              designed for larger HeroQuest projects where cards belong to playable systems rather
              than loose collections.
            </DocParagraph>
            <DocList>
              <li>
                The Decks workspace includes a deck grid for browsing/managing decks, a deck detail
                area for groups and sets, a source panel for adding cards, and details panels for
                metadata and deck actions.
              </li>
              <li>
                Decks can contain groups, sets, and front-face entries, so you can organise things
                like treasure pools, encounter groups, spell schools, hero systems, and expansion
                content in a deliberate structure.
              </li>
              <li>
                Create, rename, duplicate, delete, search, and multi-select decks from the Decks
                grid.
              </li>
              <li>
                Most deck editing is drag-and-drop: reorder groups, move sets between groups,
                reorder entries, create groups from insertion boundaries, and drag cards directly
                into sets.
              </li>
              <li>
              ...
              <li>
                The inspector can show deck membership context so it is easier to see where cards
                are used across larger projects.
              </li>
            </DocList>
          </DocSection>
          ...
          <DocSection id="pdf-export" title="PDF export">
            ...
            <DocList>
              ...
              <li>
                In scopes that include them, empty sets can export with placeholder fronts so the
                set still prints with its back face.
              </li>
              <li>
              ...
              <li>
                ...
                the alignment test PDF before a larger print run to check scale, placement, and
                which preset works best on your printer.
              </li>
              <li>
              ...
              <li>
                Manage Export Profiles from Export Settings, where you can create additional
                profiles and mark one as the default.
              </li>
              <li>
              ...
              <li>
                Large deck exports can take a little time. The app shows progress while rendering
                and lets you cancel the run if needed.
              </li>
            </DocList>
          </DocSection>
          ...
          <DocSection id="pairing" title="Card faces and pairing">
            <DocList>
              ...
              <li>
                ...
                backs, and backs can manage multiple fronts in one place. These relationships can
                also be reused in Decks set workflows.
              </li>
              <li>
          ...
          <DocSection id="exports-and-backups" title="Exporting cards and backups">
            <DocList>
              ...
              <li>
                Export options support print-oriented settings like bleed, crop marks, and cut
                marks.
              </li>
              <li>
                Rounded-corner export behavior can change depending on selected print/export
                options.
              </li>
              <li>
                In Decks, export actions are available from deck workflows so structured deck
                content can be prepared and exported from the same workspace.
              </li>
              <li>
              ...
              <li>
                Library backup now defaults to a compact .hqcc format, while older backup imports
                are still supported.
              </li>
            </DocList>
          </DocSection>
