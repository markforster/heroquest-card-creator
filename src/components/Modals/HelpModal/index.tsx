      ...
      <div className={styles.helpBody}>
        <HelpSection title="Getting around">
          <HelpParagraph>
            ...
            the inspector. The LeftNav contains quick actions (Cards, Assets, Settings/Help), the
            preview shows your card as you edit it, and the inspector on the right is where you
        ...
        <HelpSection title="Creating and editing cards">
          <HelpList>
            <li>
        ...
        <HelpSection title="Preview modes (SVG / WebGL)">
          <HelpList>
            <li>
        ...
        <HelpSection title="Text, formatting, leader lines, and alignment">
          <HelpList>
            <li>
        ...
        <HelpSection title="Text fitting and readability">
          <HelpList>
            <li>
        ...
        <HelpSection title="Working with images">
          <HelpList>
            <li>
              Open Assets to upload artwork into a shared image library (stored in your browser).
            </li>
            <li>
              In the inspector, choose an image for the current card. The tool scales it to fill the
              artwork window.
            </li>
            <li>
        ...
        <HelpSection title="Saved cards and the stockpile">
          <HelpList>
            <li>Use New in the left navigation to start a draft with a template.</li>
            <li>
        ...
        <HelpSection title="Collections (organising saved cards)">
          <HelpList>
            <li>
              In the Cards browser, the left sidebar lets you switch between All cards, Unfiled, and
              named collections.
            </li>
            <li>
        ...
        <HelpSection title="Card faces and pairing">
          <HelpList>
            <li>
            ...
            <li>
              Fronts can be paired to a back via the Combine button; backs can manage many fronts at
              once using Manage Pairings.
            </li>
          </HelpList>
        </HelpSection>

        <HelpSection title="Title visibility and borders">
          <HelpList>
        ...
        <HelpSection title="Exporting cards and backups">
          <HelpList>
            <li>
        ...
        <HelpSection title="Bulk export (downloading lots of cards)">
          <HelpList>
            <li>
