...
const IconLabelMenuButton = forwardRef<IconLabelMenuButtonHandle, IconLabelMenuButtonProps>(
  function IconLabelMenuButton(
    { label, icon: TriggerIcon, ariaLabel, disabled, className, items },
    ref,
  ) {
