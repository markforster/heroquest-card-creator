...
const DeckExportButton = forwardRef<DeckExportButtonHandle, DeckExportButtonProps>(
  function DeckExportButton(
    { deckId, scope, disabled, label, className = "btn btn-outline-light btn-sm" },
    ref,
  ) {
    const { t } = useI18n();
