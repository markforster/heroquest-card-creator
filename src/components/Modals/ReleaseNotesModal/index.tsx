        ...
        <div className={docStyles.aboutContent}>
          ...
          <div ref={contentRef} className={docStyles.docBody}>
            <DocSection id="about-what-this-is" title="What this is">
              <DocParagraph>
                HeroQuest Card Creator is a small passion project for building custom
                HeroQuest-style cards in your browser. It runs completely on the client, works from
                static files, and is designed to feel like sitting down with the original cards and
                a very friendly layout tool.
              </DocParagraph>
            </DocSection>
            ...
            <DocSection id="about-why-it-exists" title="Why it exists">
              <DocParagraph>
                ...
                , which made it possible for me to create my first homebrew cards. That tool did a
                lot of heavy lifting, but my own workflow needed something web-based, fast to load,
                and easier to run anywhere. This app is a homage to that original work: it aims to
                stay faithful to the same card layouts and options, while smoothing out the UX so
                making a new card feels quick and enjoyable.
              </DocParagraph>
            </DocSection>
            ...
            <DocSection id="about-what-you-can-do-today" title="What you can do today">
              <DocList>
                <li>
                  ...
                  treasure cards (small and large), and different card backs. Each template is tuned
                  to the proportions and typography of the classic cards.
                </li>
                <li>
                  Upload artwork into a shared asset library and reuse it across multiple cards.
                  When you pick an image, the tool automatically scales it to fit within the card
                  window, and you can fine-tune the framing.
                </li>
                <li>
                  Position card art with pixel-like precision using sliders and small step buttons
                  that nudge left, right, up or down. Scaling feels consistent regardless of the
                  underlying image size, so once you&apos;re happy with a look it&apos;s easy to
                  repeat it on other cards.
                </li>
                <li>
                ...
                <li>
                  Edit stats with compact plus/minus controls instead of dropdowns. The layout
                  mirrors the stats strip on the card so what you type on the right closely matches
                  what you see on the left.
                </li>
                <li>
                  Save your work automatically in the browser. Each template keeps its own draft,
                  and you can also save named cards into a stockpile and reload them later from the
                  Cards browser, all without creating an account or touching a server.
                </li>
                <li>
                  Build structured Decks in a dedicated workspace, using grouped sets and front-face
                  entries so larger projects can be organised as complete playable systems rather
                  than loose card lists.
                </li>
                <li>
                ...
                <li>
                  ...
                  weighted treasure pools, rarity systems, and other gameplay-oriented
                  distributions.
                </li>
                <li>
                ...
                <li>
                  ...
                  <code>.hqcc</code> file and restore it in the same or another browser, so you can
                  move work between machines or keep a local safety copy.
                </li>
                <li>
                ...
                <li>
                  Customize stat labels globally (optional), and apply custom border colours to
                  labelled backs with smart suggestions, saved swatches, and quick restore.
                </li>
                <li>
                  Use text fitting controls to keep long titles and stat headings readable, and
                  switch to the WebGL preview for a more physical, card-in-hand feel.
                </li>
                <li>
                  Pair front and back faces so related cards stay linked, with quick previews and
                  bulk pairing tools.
                </li>
                <li>
                  Export paired faces together from the inspector or include paired faces during
                  bulk export.
                </li>
                <li>Use Image Adjustments to refine scale, position, and rotation for artwork.</li>
                <li>
                  Browse example cards and screenshots to see what&apos;s possible. A growing
                  gallery of cards I&apos;ve built with this tool lives at{" "}
                  <a
            ...
            <DocSection id="about-notes-future-work" title="Notes & future work">
              <DocParagraph>
                This version is intentionally “early but useful”: it should feel about 99% usable
                for day-to-day card creation, while still leaving room for rough edges and future
              ...
              <DocParagraph className={docStyles.docParagraphSpaced}>
                The tool is confirmed working in Chrome, Safari, Edge, and Firefox on desktop.
                Mobile phones and tablets are still not supported, though they may be explored in
                future passes—no promises yet.
              </DocParagraph>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                The plan is to keep iterating, publish the code on GitHub, and provide a
                self-contained build that can be hosted anywhere. In the meantime, if this tool
                helps you create new quests, heroes, or treasure for your table, it&apos;s doing its
                job.
              </DocParagraph>
            </DocSection>
            ...
            >
              <DocParagraph>
                This app bundles Carter Sans W04 for card rendering and export. The source used for
                this font update was{" "}
                <a
            ...
            >
              <DocParagraph>
                ...
                Earlier releases laid groundwork across pairing, collections, export preparation,
                and safer workflows; v0.6.0 brings those foundations together into a structured
                deck-building experience for larger HeroQuest projects.
              </DocParagraph>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                Decks can now be organized as grouped sets with front-face entries, helping creators
                build and manage complete playable systems such as treasure ecosystems, encounter
                groups, spell schools, hero packs, and expansion content.
              </DocParagraph>
              <DocList className={docStyles.docListSpaced}>
            ...
            >
              <DocParagraph>
                ...
                empty. Assets and Stockpile now provide clearer onboarding guidance so new users can
                get started faster without guessing the next step.
              </DocParagraph>
              <DocList className={docStyles.docListSpaced}>
                <li>
            ...
            >
              <DocParagraph>
                This release expanded visual control and storage efficiency, with improvements that
                make day-to-day editing feel more flexible while keeping larger libraries lighter
                and easier to manage.
              </DocParagraph>
              <DocList className={docStyles.docListSpaced}>
                <li>
                  Added global background tint and body text color controls across templates for
                ...
                <li>
                  Introduced a compact backup format and major thumbnail/storage optimizations to
                  reduce library size.
                </li>
                <li>
                  Added system/library information improvements and contextual stockpile hints.
                </li>
              </DocList>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                Full release notes:{" "}
            ...
            >
              <DocParagraph>
                This update focused on print-readiness and presentation quality, while also
                broadening language and appearance support across the app.
              </DocParagraph>
              <DocList className={docStyles.docListSpaced}>
                <li>Added full Light, Dark, and System theme support.</li>
                <li>
                  Export workflows were significantly expanded with bleed, crop/cut marks, and
                  clearer export options.
                </li>
                <li>
                  Exported images gained subtle watermarking and metadata tagging (export-only, not
                  in editor preview).
                </li>
                <li>
                  Card canvas and print-related sizing were refined to improve consistency between
                  screen output and physical cards.
                </li>
                <li>
            ...
            >
              ...
              <DocList className={docStyles.docListSpaced}>
                ...
                <li>
                  Zoom slider feedback and marker alignment were made clearer and more predictable.
                </li>
                <li>
            ...
            >
              ...
              <DocList className={docStyles.docListSpaced}>
                <li>
                  Stockpile panels, table view, and Recently Deleted improve browsing, selection,
                  and safe recovery.
                </li>
                <li>
                ...
                <li>
                  Inline dice tokens, leader groups, and the new formatting cheat sheet make rules
            ...
            >
              ...
              <DocList className={docStyles.docListSpaced}>
                <li>
                  Front/back faces are now first-class, with clearer pairing controls in the
                  inspector and stockpile.
                </li>
                <li>
                  Back faces can manage multiple paired fronts with visual stacks and quick
                  previews.
                </li>
                <li>Export supports paired faces with a split-button and a bulk export prompt.</li>
                <li>
                  Template selection is faster with keyboard navigation and a Cmd/Ctrl+Shift+Y
                  shortcut.
                </li>
                <li>
            ...
            >
              ...
              <DocList className={docStyles.docListSpaced}>
                <li>
                  A blueprint-based renderer now drives card layouts for better consistency and
            ...
            >
              ...
              <DocList className={docStyles.docListSpaced}>
                <li>
                  Collections were added to the Cards browser, with a sidebar for All cards,
                  Unfiled, and named collections.
                </li>
                <li>
            ...
            >
              <DocParagraph>
                This pass has been all about polish and consistency rather than big new features.
                The overall look should now feel tidier, more readable, and a bit closer to a
                finished app while still keeping the same core layout and card templates.
              </DocParagraph>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                ...
                supporting actions use a lighter, outlined treatment. The save, save-as-new, and
                export buttons have been grouped and reordered so their intent and priority are
                clearer at a glance.
              </DocParagraph>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                ...
                more like a proper form, with labels, grouped controls, tooltips, and better
                spacing, so nudging and scaling artwork should feel less fussy.
              </DocParagraph>
              <DocParagraph className={docStyles.docParagraphSpaced}>
                Under the surface, a few rough edges have been smoothed out as well: modals can be
                closed with the Escape key, the save buttons behave more reliably across refreshes,
                and some stray visual glitches around the preview and inputs have been ironed out.
                There is still plenty of room for future quality-of-life improvements, but this
                update should make everyday use noticeably calmer and more consistent.
              </DocParagraph>
            </DocSection>
          </div>
        </div>
